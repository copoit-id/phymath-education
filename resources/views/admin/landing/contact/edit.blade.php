...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-500">Edit informasi kontak</p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        <form action="{{ route('admin.landing.contact.update', $contact->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="value" name="value" rows="3" required
                              ...
                              placeholder="Masukkan nilai kontak (nomor telepon, email, alamat, dll)">{{ old('value', $contact->value) }}</textarea>
                    @error('value')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="icon" name="icon" value="{{ old('icon', $contact->icon) }}"
