...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold">Tambah Hero Section</h2>
            <p class="text-gray-500">Buat banner utama landing page</p>
        </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="highlight_text" name="highlight_text" value="{{ old('highlight_text') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="primary_button_text" name="primary_button_text" value="{{ old('primary_button_text') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="primary_button_url" name="primary_button_url" value="{{ old('primary_button_url') }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="secondary_button_text" name="secondary_button_text" value="{{ old('secondary_button_text') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="secondary_button_url" name="secondary_button_url" value="{{ old('secondary_button_url') }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="stat_1_number" name="stat_1_number" value="{{ old('stat_1_number') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="stat_1_label" name="stat_1_label" value="{{ old('stat_1_label') }}" required
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="stat_2_number" name="stat_2_number" value="{{ old('stat_2_number') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="stat_2_label" name="stat_2_label" value="{{ old('stat_2_label') }}" required
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="stat_3_number" name="stat_3_number" value="{{ old('stat_3_number') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" id="stat_3_label" name="stat_3_label" value="{{ old('stat_3_label') }}" required
                ...
                <div class="border-t pt-6">
                    <div>
                        ...
                        @error('background_image')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-sm text-gray-500 mt-1">Upload gambar background untuk hero section (JPG, PNG, max 2MB)</p>
                    </div>
                </div>
