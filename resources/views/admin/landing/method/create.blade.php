...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold">Tambah Metode Pembelajaran</h2>
            <p class="text-gray-500">Tambah metode pembelajaran terdepan</p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        <form action="{{ route('admin.landing.method.store') }}" method="POST">
            @csrf
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4" required
                              ...
                              placeholder="Jelaskan metode pembelajaran ini...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
