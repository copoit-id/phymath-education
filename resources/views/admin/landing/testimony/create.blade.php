...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold">Tambah Testimony</h2>
            <p class="text-gray-500">Tambah testimoni pengguna baru</p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        <form action="{{ route('admin.landing.testimony.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="testimonial" name="testimonial" rows="4" required
                              ...
                              placeholder="Masukkan testimoni customer">{{ old('testimonial') }}</textarea>
                    @error('testimonial')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    @error('photo')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-sm text-gray-500 mt-1">Upload foto customer (JPG, PNG, max 2MB). Opsional.</p>
                </div>
