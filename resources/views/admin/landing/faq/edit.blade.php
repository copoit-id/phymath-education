...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold">Edit FAQ</h2>
            <p class="text-gray-500">Perbarui pertanyaan yang sudah ada</p>
        </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="answer" name="answer" rows="5" required
                              ...
                              placeholder="Masukkan jawaban untuk pertanyaan ini">{{ old('answer', $faq->answer) }}</textarea>
                    @error('answer')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="is_active" name="is_active"
                            ...
                            <option value="0" {{ old('is_active', $faq->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
                        @error('is_active')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
