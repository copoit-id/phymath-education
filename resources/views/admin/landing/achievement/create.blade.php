...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold">Tambah Pencapaian Siswa</h2>
            <p class="text-gray-500">Tambah pencapaian terbaru siswa</p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        <form action="{{ route('admin.landing.achievement.store') }}" method="POST">
            @csrf
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="achievement" name="achievement" value="{{ old('achievement') }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="before_score" name="before_score" value="{{ old('before_score') }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="after_score" name="after_score" value="{{ old('after_score') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="improvement" name="improvement" value="{{ old('improvement') }}"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                              ...
                              placeholder="Jelaskan pencapaian ini lebih detail...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
