...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold">Tambah Rating</h2>
            <p class="text-gray-500">Tambah rating dan ulasan keseluruhan</p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        <form action="{{ route('admin.landing.rating.store') }}" method="POST">
            @csrf
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="rating_value" name="rating_value" value="{{ old('rating_value') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" id="total_reviews" name="total_reviews" value="{{ old('total_reviews') }}"
                               min="0" required
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                              ...
                              placeholder="Deskripsi tambahan untuk rating ini...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
